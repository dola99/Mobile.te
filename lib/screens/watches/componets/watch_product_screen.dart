...
import 'package:mobility/screens/watches/componets/container_of_watch_product.dart';
...
class ProductWatchDetailScreen extends StatelessWidget {
  ...
  final List? images;
  const ProductWatchDetailScreen({
    this.nameProduct,
    this.logo,
    this.mainImage,
    this.blutooth,
                ...
                child: Column(
                  children: [
                    ...
                    ContainerOfWatchPrduct(
                      name: 'screen',
                      text: size,
                      widget: SvgPicture.asset('assets/images/watchscreen.svg'),
                    ),
                    ContainerOfWatchPrduct(
                      name: 'screen Type',
                      text: screenType,
